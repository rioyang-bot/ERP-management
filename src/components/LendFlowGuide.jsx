...
const STAGES = [
  ...
  },
  {
    ...
    status: <span style={chip('rgba(217, 119, 6, 0.14)', '#d97706')}>借出中 (待歸還)</span>,
    asset: '設備/硬體列表上該序號顯示為「借出」狀態。',
    consumable: '耗材列表的「借出中」欄位顯示目前在外的數量。',
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: '620px' }}>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style={td}>設備／硬體列表的「狀態」欄顯示「借出」</td>
              <td style={td}>耗材列表的「借出中」欄位顯示數量</td>
            </tr>
            <tr>
