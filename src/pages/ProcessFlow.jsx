  ...
  const modulesData = useMemo(() => [
    ...
    },
    {
      ...
      businessRules: [
        ...
        '細項不勾選：範本裡定義的是欄位名稱（例如「OS」），由設備填寫實際內容（例如「RH9.6」），離開欄位即自動儲存。細項預設由每台設備各自挑選或新增；若每台都要填，可在範本頁勾選該細項前方的框，即與主要檢查功能一樣自動套用到該廠牌的所有設備。主要檢查功能以勾選表示檢查完成，設備列表狀態欄底下顯示的完成進度只計算主要檢查功能。',
