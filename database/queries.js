export const queries = {
  ...
  deleteDeviceType: `DELETE FROM item_types WHERE name = $1 AND category_id = (SELECT id FROM categories WHERE name = $2) AND brand_id = (SELECT id FROM item_brands WHERE name = $3 AND category_id = (SELECT id FROM categories WHERE name = $2))`,
  insertDeviceModel: `INSERT INTO item_models (type_id, name) VALUES ((SELECT t.id FROM item_types t JOIN item_brands b ON t.brand_id = b.id WHERE b.name = $1 AND t.name = $2 AND b.category_id = (SELECT id FROM categories WHERE name = $3) AND t.category_id = (SELECT id FROM categories WHERE name = $3)), $4)`,
  deleteDeviceModel: `DELETE FROM item_models WHERE name = $1 AND type_id = (SELECT t.id FROM item_types t JOIN item_brands b ON t.brand_id = b.id WHERE b.name = $2 AND t.name = $3 AND b.category_id = (SELECT id FROM categories WHERE name = $4) AND t.category_id = (SELECT id FROM categories WHERE name = $4))`,
